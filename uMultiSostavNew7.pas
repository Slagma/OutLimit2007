...
function TfMultiSostavNew7.DoMnogitel(Value : Double; Y : Integer) : Double;
var
  MyField : TField;
begin
  Result := Value;
...
procedure TfMultiSostavNew7.DoEmptyTables;
begin
  tPlata.EmptyTable;
  tTemp4.EmptyTable;
end;

procedure TfMultiSostavNew7.DoOpenTables;
begin
...
procedure TfMultiSostavNew7.DoWork;
var
...
procedure TfMultiSostavNew7.FillVolumes;
var
  TempDate, Dt  : TDate;
  MyY, MyM, MyD : Word;
  NormaD : TDate;
...
procedure TfMultiSostavNew7.tTemp4CalcFields(DataSet: TDataSet);
begin
...
function TfMultiSostavNew7.GetV_Phakt(V : Integer; Y : Integer; D : TDate) : Double;
begin
  Result := 0.0;
  tTemp4.First;
  while not tTemp4.Eof do
...
function TfMultiSostavNew7.GetV_Limit(V : Integer; Y : Integer; D : TDate) : Double;
begin
  Result := 0.0;
  tTemp4.First;
  while not tTemp4.Eof do
...
procedure TfMultiSostavNew7.CalcPlata;
var
...
procedure TfMultiSostavNew7.ppLabel40GetText(Sender: TObject;
  var Text: String);
begin
  Text := DateToStr(BeginDate);
end;

procedure TfMultiSostavNew7.ppLabel38GetText(Sender: TObject;
  var Text: String);
begin
  Text := DateToStr(EndDate);
end;

procedure TfMultiSostavNew7.ppLabel43GetText(Sender: TObject;
  var Text: String);
begin
  Text := Format('%0.2f руб.', [StrToFloat(ppDBCalc5.Text)+StrToFloat(ppVariable2.Text)]);
end;

procedure TfMultiSostavNew7.ppLabel48GetText(Sender: TObject;
  var Text: String);
begin
  Text := fMain.CurOtdel;
end;

procedure TfMultiSostavNew7.ppLabel49GetText(Sender: TObject;
  var Text: String);
begin
  Text := fMain.CurBoss;
end;

procedure TfMultiSostavNew7.ppLabel53GetText(Sender: TObject;
  var Text: String);
begin
  Text := fMain.CurPhone;
end;

procedure TfMultiSostavNew7.tPlataCalcFields(DataSet: TDataSet);
var
        ...
        if tPlataNormaDate.Value < StrToDate(fMain.CurNormativs) then
          tPlataPlataString.Value :=
           'Плата = ('+ Format('%0.3f', [tPlataC_PHAKT.Value]) +
                               ...
                               Format('%g', [tPlataV_PHAKT.Value])+ ' * 5.0' + ' = '+
...
procedure TfMultiSostavNew7.ppDBText1GetText(Sender: TObject;
  var Text: String);
begin
...
procedure TfMultiSostavNew7.ppDBText5GetText(Sender: TObject;
  var Text: String);
begin
  if tPlataCodeIngrid.Value = PH then Text := '';
end;

procedure TfMultiSostavNew7.FormCreate(Sender: TObject);
begin
  Rep.PrinterSetup.MarginBottom := fMain.CurMargin;
end;

procedure TfMultiSostavNew7.ppGroupHeaderBand5BeforePrint(Sender: TObject);
begin
...
procedure TfMultiSostavNew7.ppGroupFooterBand5BeforePrint(Sender: TObject);
begin
  if WithGrouppa = 0 then
  begin
    if WithNorma = 1 then
...
procedure TfMultiSostavNew7.ppGroupHeaderBand6BeforePrint(Sender: TObject);
begin
...
procedure TfMultiSostavNew7.RepPreviewFormCreate(Sender: TObject);
begin
  Rep.PreviewForm.WindowState := wsMaximized;
end;

procedure TfMultiSostavNew7.ppLabel16GetText(Sender: TObject;
  var Text: String);
begin
//  case WithNorma of
//    0 :;
...
procedure TfMultiSostavNew7.FillVolumes2;
var
  TempDate, Dt  : TDate;
  MyY, MyM, MyD : Word;
  NormaD : TDate;
...
procedure TfMultiSostavNew7.ppGroupFooterBand7BeforePrint(Sender: TObject);
begin
  if WithGrouppa = 0 then
...
procedure TfMultiSostavNew7.ppDBText23GetText(Sender: TObject;
  var Text: String);
begin
...
procedure TfMultiSostavNew7.ppDBText22GetText(Sender: TObject;
  var Text: String);
begin
