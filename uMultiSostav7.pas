...
function TfMultiSostav7.DoMnogitel(Value : Double; Y : Integer) : Double;
var
  MyField : TField;
begin
  Result := Value;
...
procedure TfMultiSostav7.DoEmptyTables;
begin
  tPlata.EmptyTable;
  tTemp4.EmptyTable;
end;

procedure TfMultiSostav7.DoOpenTables;
begin
...
procedure TfMultiSostav7.DoWork;
var
...
procedure TfMultiSostav7.FillVolumes;
var
  TempDate, Dt  : TDate;
  MyY, MyM, MyD : Word;
  NormaD : TDate;
...
procedure TfMultiSostav7.tTemp4CalcFields(DataSet: TDataSet);
begin
...
function TfMultiSostav7.GetV_Phakt(V : Integer; Y : Integer; D : TDate) : Double;
begin
  Result := 0.0;
  tTemp4.First;
  while not tTemp4.Eof do
...
function TfMultiSostav7.GetV_Limit(V : Integer; Y : Integer; D : TDate) : Double;
begin
  Result := 0.0;
  tTemp4.First;
  while not tTemp4.Eof do
...
procedure TfMultiSostav7.CalcPlata;
var
...
procedure TfMultiSostav7.ppLabel40GetText(Sender: TObject;
  var Text: String);
begin
  Text := DateToStr(BeginDate);
end;

procedure TfMultiSostav7.ppLabel38GetText(Sender: TObject;
  var Text: String);
begin
  Text := DateToStr(EndDate);
end;

procedure TfMultiSostav7.ppLabel43GetText(Sender: TObject;
  var Text: String);
begin
  Text := Format('%0.2f руб.', [StrToFloat(ppDBCalc5.Text)+StrToFloat(ppVariable2.Text)]);
end;

procedure TfMultiSostav7.ppLabel48GetText(Sender: TObject;
  var Text: String);
begin
  Text := fMain.CurOtdel;
end;

procedure TfMultiSostav7.ppLabel49GetText(Sender: TObject;
  var Text: String);
begin
  Text := fMain.CurBoss;
end;

procedure TfMultiSostav7.ppLabel53GetText(Sender: TObject;
  var Text: String);
begin
  Text := fMain.CurPhone;
end;

procedure TfMultiSostav7.tPlataCalcFields(DataSet: TDataSet);
var
...
procedure TfMultiSostav7.ppDBText1GetText(Sender: TObject;
  var Text: String);
begin
...
procedure TfMultiSostav7.ppDBText5GetText(Sender: TObject;
  var Text: String);
begin
  if tPlataCodeIngrid.Value = PH then Text := '';
end;

procedure TfMultiSostav7.FormCreate(Sender: TObject);
begin
  Rep.PrinterSetup.MarginBottom := fMain.CurMargin;
end;

procedure TfMultiSostav7.ppGroupHeaderBand5BeforePrint(Sender: TObject);
begin
...
procedure TfMultiSostav7.ppGroupFooterBand5BeforePrint(Sender: TObject);
begin
  if WithGrouppa = 0 then
  begin
    if WithNorma = 1 then
...
procedure TfMultiSostav7.ppGroupHeaderBand6BeforePrint(Sender: TObject);
begin
...
procedure TfMultiSostav7.RepPreviewFormCreate(Sender: TObject);
begin
  Rep.PreviewForm.WindowState := wsMaximized;
end;

procedure TfMultiSostav7.ppLabel16GetText(Sender: TObject;
  var Text: String);
begin
//  case WithNorma of
//    0 :;
...
procedure TfMultiSostav7.FillVolumes2;
var
  TempDate, Dt  : TDate;
  MyY, MyM, MyD : Word;
  NormaD : TDate;
...
procedure TfMultiSostav7.ppGroupFooterBand7BeforePrint(Sender: TObject);
begin
  if WithGrouppa = 0 then
...
procedure TfMultiSostav7.ppDBText23GetText(Sender: TObject;
  var Text: String);
begin
...
procedure TfMultiSostav7.ppDBText22GetText(Sender: TObject;
  var Text: String);
begin
